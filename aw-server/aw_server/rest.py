...
# DATA API (for UI refactoring)


@api.route("/0/data/hourly")
class HourlyDataResource(Resource):
    def get(self):
        ...
        # TODO: Implement hourly data endpoint
        return jsonify([])


@api.route("/0/data/gantt")
class GanttDataResource(Resource):
    def get(self):
        # TODO: Implement gantt data endpoint
        return jsonify([])


@api.route("/0/data/heatmap")
class HeatmapDataResource(Resource):
    def get(self):
        # TODO: Implement heatmap data endpoint
        return jsonify([])


@api.route("/0/data/colors")
class ColorMappingResource(Resource):
    def get(self):
        # TODO: Implement color mapping endpoint
        return jsonify({})
        return data
